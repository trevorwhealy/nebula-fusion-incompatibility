...
function () {
  function AttributeTransitionManager(gl, _ref) {
    ...
    if (_luma._Transform.isSupported(gl)) {
  ...
  _createClass(AttributeTransitionManager, [{
    ...
    value: function _createModel() {
      ...
      this.transform = new _luma._Transform(this.gl, Object.assign({
        elementCount: this.numInstances
    ...
    value: function _getNextTransitionStates(transition, settings) {
      ...
      var fromLength = _instanceof(fromState, _luma.Buffer) && fromState.getElementCount() || toLength; // Alternate between two buffers when new transitions start.
