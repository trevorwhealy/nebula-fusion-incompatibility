...
function (_Layer) {
  ...
  _createClass(ScreenGridLayer, [{
    ...
    value: function updateState(opts) {
      _get(ScreenGridLayer.prototype.__proto__ || Object.getPrototypeOf(ScreenGridLayer.prototype), "updateState", this).call(this, opts);
    ...
    value: function _updateAggregation(changeFlags) {
      ...
      var projectPoints = _instanceof(this.context.viewport, _core.WebMercatorViewport);
