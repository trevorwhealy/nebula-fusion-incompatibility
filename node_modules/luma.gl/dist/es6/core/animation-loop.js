...
export default class AnimationLoop {
  ...
  start(opts = {}) {
    ...
    if (!this._animationFrameId) {
      ...
      this._startPromise = pageLoadPromise.then(() => {
        ...
        this._createFramebuffer(); // Initialize the callback data
  ...
  _updateCallbackData() {
    ...
    this.needsRedraw = null; // CallbackData width and height represent drawing buffer width and height
    ...
    this.animationProps.tock = Math.floor(this.animationProps.time / 1000 * 60); // experimental
