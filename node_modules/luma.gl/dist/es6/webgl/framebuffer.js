...
export default class Framebuffer extends Resource {
  ...
  attach(attachments, {
    ...
    const prevHandle = this.gl.bindFramebuffer(GL.FRAMEBUFFER, this.handle); // Walk the attachments
  ...
  getAttachmentParameters(attachment = GL.COLOR_ATTACHMENT0, parameters = this.constructor.ATTACHMENT_PARAMETERS || {}) {
    const values = {};
