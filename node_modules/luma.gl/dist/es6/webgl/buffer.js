...
export default class Buffer extends Resource {
  constructor(gl, props = {}) {
    super(gl, props); // Supports signature `new Buffer(gl, new Float32Array(...)`
  ...
  initialize(props = {}) {
    let data = props.data,
        bytes = props.bytes;
    const _props$usage = props.usage,
  ...
  bind({
    ...
    const type = target === GL.UNIFORM_BUFFER || target === GL.TRANSFORM_FEEDBACK_BUFFER ? size !== undefined ? 'ranged' : 'indexed' : 'non-indexed';
