...
export default class Program extends Resource {
  constructor(gl, opts = {}) {
    super(gl, opts); // For backwards compatibility, each program creates a vertex array.
  ...
  initialize(props = {}) {
    ...
    assert(this.fs instanceof FragmentShader, 'Program: bad fragment shader'); // uniforms
  ...
  draw({
    ...
    instanceCount = 0,
    vertexArray = null,
    // VertexArray.getDefaultArray(this.gl),
    transformFeedback,
    framebuffer,
    uniforms = {},
    samplers = {},
    ...
    if (logPriority !== undefined) {
      ...
      const message = `Framebuffer=${fb}: mode=${drawMode} verts=${vertexCount} instances=${instanceCount}` + ` isIndexed=${isIndexed} isInstanced=${isInstanced}`;
