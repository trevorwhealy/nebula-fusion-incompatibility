...
export { default as _AnimationLoopProxy } from './core/animation-loop-proxy'; // Geometry
...
export { assembleShaders } from './shadertools/src/lib/assemble-shaders'; // shader modules
...
export { default as diffuse } from './shadertools/src/modules/diffuse/diffuse'; // DEPRECATED EXPORTS IN v6.0
