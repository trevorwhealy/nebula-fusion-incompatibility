...
function (_Resource) {
  ...
  function Framebuffer(gl) {
    ...
    _this.height = null;
    _this.attachments = {};
    _this.readBuffer = GL.COLOR_ATTACHMENT0;
    _this.drawBuffers = [GL.COLOR_ATTACHMENT0];
  ...
  _createClass(Framebuffer, [{
    ...
    value: function update(_ref3) {
      ...
      var prevHandle = gl.bindFramebuffer(GL.FRAMEBUFFER, this.handle);
    ...
    value: function attach(attachments) {
      ...
      var prevHandle = this.gl.bindFramebuffer(GL.FRAMEBUFFER, this.handle); // Walk the attachments
      ...
      this.gl.bindFramebuffer(GL.FRAMEBUFFER, prevHandle || null); // Assign to attachments and remove any nulls to get a clean attachment map
    ...
    value: function clear() {
      ...
      var prevHandle = this.gl.bindFramebuffer(GL.FRAMEBUFFER, this.handle);
    ...
    value: function readPixels(_ref7) {
      var _ref7$x = _ref7.x,
          ...
          attachment = _ref7$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref7$attachment;
    ...
    value: function copyToDataUrl() {
      var _ref9 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          attachment = _ref9$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref9$attachment,
    ...
    value: function copyToImage() {
      var _ref10 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          attachment = _ref10$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref10$attachment,
    ...
    value: function copyToTexture(_ref11) {
      var texture = _ref11.texture,
          ...
          attachment = _ref11$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref11$attachment,
          _ref11$x = _ref11.x,
    ...
    value: function blit(_ref12) {
      var srcFramebuffer = _ref12.srcFramebuffer,
          ...
          attachment = _ref12$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref12$attachment,
      ...
      var prevDrawHandle = gl.bindFramebuffer(GL.DRAW_FRAMEBUFFER, this.handle);
      var prevReadHandle = gl.bindFramebuffer(GL.READ_FRAMEBUFFER, srcFramebuffer.handle);
    ...
    value: function invalidate(_ref13) {
      ...
      var gl = this.gl;
      assertWebGL2Context(gl);
      var prevHandle = gl.bindFramebuffer(GL.READ_FRAMEBUFFER, this.handle);
    ...
    value: function getAttachmentParameter() {
      var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          attachment = _ref14$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref14$attachment,
          pname = _ref14.pname;
    ...
    value: function getAttachmentParameters() {
      var attachment = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : GL.COLOR_ATTACHMENT0;
    ...
    value: function bind() {
      var _ref15 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          target = _ref15$target === void 0 ? GL.FRAMEBUFFER : _ref15$target;
    ...
    value: function unbind() {
      var _ref16 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          target = _ref16$target === void 0 ? GL.FRAMEBUFFER : _ref16$target;
    ...
    value: function _attachRenderbuffer(_ref19) {
      var _ref19$attachment = _ref19.attachment,
          attachment = _ref19$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref19$attachment,
      ...
      gl.framebufferRenderbuffer(GL.FRAMEBUFFER, attachment, GL.RENDERBUFFER, renderbuffer.handle); // TODO - is the unbind needed?
    ...
    value: function _attachTexture(_ref20) {
      var _ref20$attachment = _ref20.attachment,
          attachment = _ref20$attachment === void 0 ? GL.COLOR_ATTACHMENT0 : _ref20$attachment,
    ...
    value: function _setReadBuffer(gl, readBuffer) {
      if (isWebGL2(gl)) {
        ...
        assert(readBuffer === GL.COLOR_ATTACHMENT0 || readBuffer === GL.BACK, ERR_MULTIPLE_RENDERTARGETS);
      }
    ...
    value: function _setDrawBuffers(gl, drawBuffers) {
      if (isWebGL2(gl)) {
        ...
        if (ext) {
          ...
          assert(drawBuffers.length === 1 && (drawBuffers[0] === GL.COLOR_ATTACHMENT0 || drawBuffers[0] === GL.BACK), ERR_MULTIPLE_RENDERTARGETS);
        }
      }
