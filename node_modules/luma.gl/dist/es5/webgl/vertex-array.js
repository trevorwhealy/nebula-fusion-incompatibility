...
function (_Resource) {
  ...
  _createClass(VertexArray, [{
    ...
    value: function setAttributes(attributes) {
      ...
      this.bind(function () {
        for (var locationOrName in attributes) {
          ...
          if (Array.isArray(value) && value.length && _instanceof(value[0], _buffer.default)) {
            var buffer = value[0];
            var accessor = value[1];

            _this3.setBuffer(locationOrName, buffer, accessor);
          } else if (_instanceof(value, _buffer.default)) {
    ...
    value: function setElements() {
      ...
      var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      (0, _utils.assert)(!elementBuffer || elementBuffer.target === GL_ELEMENT_ARRAY_BUFFER, ERR_ELEMENTS);
      this.bind(function () {
    ...
    value: function setBuffer(locationOrName, buffer) {
      ...
      this.bind(function () {
        ...
        var accessor = accessInfo ? accessInfo.accessor : new _accessor2.default();
        ...
        (0, _utils.assert)(Number.isFinite(size) && Number.isFinite(type)); // A non-zero buffer object must be bound to the GL_ARRAY_BUFFER target
    ...
    value: function unbindBuffers() {
      ...
      this.bind(function () {
        ...
        _this7.unbindBuffer = _this7.unbindBuffer || new _buffer.default(_this7.gl, {
          size: 4
        });

        for (var location in _this7.values) {
          if (_instanceof(_this7.values[location], _buffer.default)) {
    ...
    value: function bindBuffers() {
      ...
      this.bind(function () {
        for (var location in _this8.values) {
          ...
          if (_instanceof(buffer, _buffer.default)) {
    ...
    value: function _getParameter(pname, _ref) {
      ...
      return this.bind(function () {
        switch (pname) {
          case _constants.default.VERTEX_ATTRIB_ARRAY_POINTER:
    ...
    value: function _getDebugTable() {
      ...
      for (var attributeName in attributes) {
        ...
        if (info) {
          ...
          if (accessor) {
            var typeAndName = (0, _attributeUtils.getCompositeGLType)(accessor.type, accessor.size);
    ...
    value: function _getDebugTableRow(attribute, accessor, header) {
      ...
      if (_instanceof(attribute, _buffer.default)) {
        var _ref3;
        ...
        return _ref3 = {}, _defineProperty(_ref3, header, "".concat(marker).concat((0, _utils.formatValue)(value, {
          size: size,
          isInteger: isInteger
      ...
      isInteger = type.indexOf('nt') !== -1;
      return _ref4 = {}, _defineProperty(_ref4, header, "".concat((0, _utils.formatValue)(value, {
        size: size,
        isInteger: isInteger
