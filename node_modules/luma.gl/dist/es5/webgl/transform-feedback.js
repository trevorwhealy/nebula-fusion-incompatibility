...
function (_Resource) {
  ...
  function TransformFeedback(gl) {
    ...
    _this = _possibleConstructorReturn(this, (TransformFeedback.__proto__ || Object.getPrototypeOf(TransformFeedback)).call(this, gl, props));
  ...
  _createClass(TransformFeedback, [{
    ...
    value: function begin() {
      var primitiveMode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants.default.POINTS;
      this.gl.bindTransformFeedback(_constants.default.TRANSFORM_FEEDBACK, this.handle);
    ...
    value: function end() {
      ...
      this.gl.bindTransformFeedback(_constants.default.TRANSFORM_FEEDBACK, null);
      return this;
    } // PRIVATE METHODS
    ...
    value: function _bindBuffer(index, buffer) {
      ...
      if (!handle || size === undefined) {
        this.gl.bindBufferBase(_constants.default.TRANSFORM_FEEDBACK_BUFFER, index, handle);
      } else {
        this.gl.bindBufferRange(_constants.default.TRANSFORM_FEEDBACK_BUFFER, index, handle, offset, size);
      }
