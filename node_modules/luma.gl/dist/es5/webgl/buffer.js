...
function (_Resource) {
  ...
  function Buffer(gl) {
    ...
    _this.target = props.target || (_this.gl.webgl2 ? _constants.default.COPY_READ_BUFFER : _constants.default.ARRAY_BUFFER);
  ...
  _createClass(Buffer, [{
    ...
    value: function initialize() {
      ...
      var _props$usage = props.usage,
          usage = _props$usage === void 0 ? _constants.default.STATIC_DRAW : _props$usage;
      var type;
      ...
      this.setAccessor(new _accessor.default(type ? {
        type: type
      } : {}, props, props.accessor)); // Create the buffer - binding it here for the first time locks the type
      // In WebGL2, use GL.COPY_WRITE_BUFFER to avoid locking the type

      var target = this.gl.webgl2 ? _constants.default.COPY_WRITE_BUFFER : this.target;
    ...
    value: function copyData(_ref2) {
      ...
      gl.bindBuffer(_constants.default.COPY_READ_BUFFER, sourceBuffer.handle);
      gl.bindBuffer(_constants.default.COPY_WRITE_BUFFER, this.handle);
      gl.copyBufferSubData(_constants.default.COPY_READ_BUFFER, _constants.default.COPY_WRITE_BUFFER, readOffset, writeOffset, size);
      gl.bindBuffer(_constants.default.COPY_READ_BUFFER, null);
      gl.bindBuffer(_constants.default.COPY_WRITE_BUFFER, null); // TODO - update local `data` if offsets are 0
    ...
    value: function getData() {
      ...
      (0, _webglUtils.assertWebGL2Context)(this.gl);
      var ArrayType = (0, _typedArrayUtils.getTypedArrayFromGLType)(this.accessor.type || _constants.default.FLOAT, {
        clamped: false
      });
      ...
      this.gl.bindBuffer(_constants.default.COPY_READ_BUFFER, this.handle);
      this.gl.getBufferSubData(_constants.default.COPY_READ_BUFFER, srcByteOffset, dstData, dstOffset, length);
      this.gl.bindBuffer(_constants.default.COPY_READ_BUFFER, null); // TODO - update local `data` if offsets are 0
    ...
    value: function bind() {
      ...
      var type = target === _constants.default.UNIFORM_BUFFER || target === _constants.default.TRANSFORM_FEEDBACK_BUFFER ? size !== undefined ? 'ranged' : 'indexed' : 'non-indexed';
    ...
    value: function unbind() {
      ...
      var isIndexedBuffer = target === _constants.default.UNIFORM_BUFFER || target === _constants.default.TRANSFORM_FEEDBACK_BUFFER;
