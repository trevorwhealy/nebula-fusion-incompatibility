...
function (_Object3D) {
  ...
  _createClass(Model, [{
    ...
    value: function transform() {
      ...
      if (discard) {
        parameters = Object.assign({}, parameters, _defineProperty({}, _constants.default.RASTERIZER_DISCARD, discard));
      }
    ...
    value: function _createProgram(_ref2) {
      var _ref2$vs = _ref2.vs,
          ...
          bufferMode = _ref2$bufferMode === void 0 ? _constants.default.SEPARATE_ATTRIBS : _ref2$bufferMode,
      ...
      (0, _assert.default)(_instanceof(program, _webgl.Program), 'Model needs a program');
      return program;
    }
    ...
    value: function _createBuffersFromAttributeDescriptors(attributes) {
      ...
      for (var attributeName in attributes) {
        ...
        if (_instanceof(descriptor, _attribute.default)) {
          attribute = descriptor;
        } else if (_instanceof(descriptor, _webgl.Buffer)) {
          attribute = attribute || new _attribute.default(gl, Object.assign({}, descriptor.layout, {
            id: attributeName
          }));
          attribute.update({
            buffer: descriptor
